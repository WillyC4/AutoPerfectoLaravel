        ...
        <div class="card-body">
            <form action="{{ route('autos.update', $auto->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="marca" value="{{ $auto->marca }}" class="form-control border-secondary" placeholder="Marca">
                </div>

                <div class="mb-3">
                    <label for="modelo" class="form-label fw-bold">Modelo:</label>
                    <input type="text" name="modelo" value="{{ $auto->modelo }}" class="form-control border-secondary" placeholder="Modelo">
                </div>

                <div class="mb-3">
                    <label for="anio" class="form-label fw-bold">Año:</label>
                    <input type="text" name="anio" value="{{ $auto->anio }}" class="form-control border-secondary" placeholder="Año">
                </div>
