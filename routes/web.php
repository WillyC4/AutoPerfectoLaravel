...
Route::middleware(['auth', 'role:admin,cliente'])->group(function () {
    ...
    Route::get('/comparar/seguridad', function () {return view('comparar.seguridad');})->name('comparar.seguridad');

    Route::get('/comparar/segmento', [ComparadorController::class, 'mostrarSegmento'])->name('comparar.segmento');
    
    Route::get('/comparar/ranking', function () {return view('comparar.ranking');})->name('comparar.ranking');

    Route::get('/comparar/precio', function () {return view('comparar.precio');})->name('comparar.precio');
    ...
    Route::get('/comparar/resultado', [ComparadorController::class, 'comparar'])->name('comparar.resultado');
